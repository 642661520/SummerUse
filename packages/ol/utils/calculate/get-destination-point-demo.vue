...
<script lang="ts" setup>
  ...
  import { OlMap, getOSMLayer, EPSG_4326, createVectorLayer, getDestinationPoint, createStyle } from '@summeruse/ol';
  import { computed, ref, watchEffect } from 'vue';
  import { Point } from 'ol/geom';
  import { NInputNumber, NFormItem, NForm } from 'naive-ui';
